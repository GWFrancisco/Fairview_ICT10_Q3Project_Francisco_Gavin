...
def checkUsername():
    ...
    # calculates remaining characters needed
...
def check(e=None): # conditioning, without this wont it work, if data input by user matches, it will result in the result below
    ...
    if registration == "" or medical == "" or grade == "" or section == "": # if nothing is inputted, it will say please complete all fields
    ...
    team = intramsteams.get(section, None) # the result, if successfully eligible it will present your intrams team, if not, it will show error and prompts to try again
    if team:
        display(f"Congratulations! You are part of the {team}, hooray!", target="output") # part of the team if eligible and correct inputs
    else:
